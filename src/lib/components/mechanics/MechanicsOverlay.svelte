...
<OverlaySurface bind:open title="Country Mechanics">
  ...
  <div class="body">
    ...
    {#if loading}
      <LoadingState label="Loading mechanics…" />
    {:else if error}
...
<style>
  .famsel { background: var(--bg-1); border: 1px solid var(--border); color: var(--text-1); font-family: inherit; font-size: 0.83rem; padding: 0.2rem 0.4rem; }
  .search { background: var(--bg-1); border: 1px solid var(--border); color: var(--text-1); font-family: inherit; font-size: 0.83rem; padding: 0.2rem 0.4rem; width: 14rem; }
  ...
  .nocreate { color: var(--text-2); font-size: 0.82rem; font-style: italic; padding: 0.15rem 0; }
  ...
  .grpsel { background: var(--bg-1); border: 1px solid var(--border); color: var(--text-1); font-family: inherit; font-size: 0.82rem; padding: 0.22rem 0.35rem; }
  ...
  .cswatch { width: 0.85rem; height: 0.85rem; border: 1px solid var(--border); flex: none; }
  ...
  .grp { color: var(--warn); background: var(--bg-0); padding: 0 0.3rem; font-size: 0.72rem; }
